...
router.get("/", (0, auth_1.default)(client_1.UserRole.vendor, client_1.UserRole.admin), coupon_conrtoller_1.CouponController.getVendorCoupon);
router.get("/all", (0, auth_1.default)(client_1.UserRole.admin), coupon_conrtoller_1.CouponController.getVendorCoupon);
...
router.delete("/:id", (0, auth_1.default)(client_1.UserRole.vendor, client_1.UserRole.admin), coupon_conrtoller_1.CouponController.deleteCoupon);
